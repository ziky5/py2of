...
def test_print_header_dictionary() -> None:
    header = OfHeader(classname=FieldClass.Dictionary, name='genericObject')
    expected_output = """\
version 2.0;
format ascii;
class dictionary;
...
def test_print_header_scalar_field() -> None:
    header = OfHeader(classname=FieldClass.ScalarField, name='genericObject')
    expected_output = """\
version 2.0;
format ascii;
...
def test_print_header_tensor_field() -> None:
    header = OfHeader(classname=FieldClass.TensorField, name='genericObject')
    expected_output = """\
version 2.0;
format ascii;
...
def test_print_header_regioobject() -> None:
    header = OfHeader(classname=FieldClass.RegIOObject, name='genericObject')
    expected_output = """\
version 2.0;
format ascii;
class regIOobject;
...
def test_print_header_binary_format() -> None:
    header = OfHeader(classname=FieldClass.VectorField, name='genericObject', format=DataFormat.Binary)
    expected_output = """\
version 2.0;
format binary;
class volVectorField;
...
def test_print_header_nondefault_version() -> None:
    header = OfHeader(classname=FieldClass.VectorField, name='genericObject', version=1.5)
    expected_output = """\
version 1.5;
format ascii;
class volVectorField;
